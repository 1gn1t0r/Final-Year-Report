...
\part{Literature Review}\label{part:lit}
\include{Chapters/Chapter02}
\cleardoublepage
\part{Conceptual Design} \label{part:concept}
\include{Chapters/Chapter03}
\part{Algorithm Design} \label{part:algo}
\include{Chapters/Chapter04}
\part{Detail Design} \label{part:detail}
\include{Chapters/Chapter05}
\part{Denouement} \label{part:concl}
