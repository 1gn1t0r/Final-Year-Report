...
\[ \frac{f}{N} < k \]
where f is the frequency of the note, N the total number of notes and k the threshold. Filtering was not applied on rests. In the first attempt rests where accounted for in tracks with a large amount of rests, the regular notes may be filtered out.
