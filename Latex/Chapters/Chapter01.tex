...
Algorithmic music composition is of theoretical interest and research has been done for composing music by genetic algorithms and neural networks.
...
\section{Solution}
\begin{figure}
\centerline{\includegraphics[width=300px]{../images/arch.png}}
...
\begin{enumerate}
\item Be able to compose and play monophonic melodies
\item Melodies are to be composed using machine learning algorithms
\item Melodies should be composed according to a certain style
\item The user should be able to select the style
\item The application will feature a \acs{MIDI} library which is to be used as training data for the machine learning algorithms
\end{enumerate}
...
More recent studies into recurrent neural networks based on \ac{LTSM} indicate that it is indeed possible to compose music using recurrent neural networks that have global structure \cite{Eck2002}.
...
\begin{itemize}
\item Recurrent neural networks \cite{mozer1994neural,Eck2002,Chen2001}
...
\item Genetic algorithms employing Zipf's law and cosine similarity \cite{Manaris2007,Manaris2005,Dostal2013}
\item Interactive genetic algorithms \cite{Biles1996, Biles1994,Unehara,Spector_inductionand,Johanson1998}
\end{itemize}
...
\item Prototyping of different strategies
\end{itemize}
\item Construction
\begin{itemize}
